...
| ------- | ---- | ------------- | ------- |
| 4.6 | `universal-bookmarklet-menu.user.js` | NotebookLM disappearing pop-up (#25) | - "📓 NotebookLM" and "📓 NotebookLM Basket" now show the Gemini-style disappearing pop-up for ~1s before opening NotebookLM, so the user sees the "paste with CTRL+V" message first |
